      ...
      <div className="pencil-loader-wrap">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="pencil">
          ...
          <g transform="translate(100,100)" className="pencil__rotate">
            <g fill="none">
              <circle transform="rotate(-90)" strokeDashoffset="402" strokeDasharray="402.12 402.12" strokeWidth="30" stroke="#5f7f6b" r="64" className="pencil__body1" />
              <circle transform="rotate(-90)" strokeDashoffset="465" strokeDasharray="464.96 464.96" strokeWidth="10" stroke="#91aa98" r="74" className="pencil__body2" />
              <circle transform="rotate(-90)" strokeDashoffset="339" strokeDasharray="339.29 339.29" strokeWidth="10" stroke="#3f5f4c" r="54" className="pencil__body3" />
            </g>
            <g transform="rotate(-90) translate(49,0)" className="pencil__eraser"><g className="pencil__eraser-skew">
              <rect height="30" width="30" ry="5" rx="5" fill="#91aa98" /><rect clipPath="url(#pencil-eraser)" height="30" width="5" fill="#718b7a" /><rect height="20" width="30" fill="#e7e7e4" /><rect height="20" width="15" fill="#bdbdb9" /><rect height="20" width="5" fill="#d3d3cf" /><rect height="2" width="30" y="6" fill="rgba(20,30,24,.2)" /><rect height="2" width="30" y="13" fill="rgba(20,30,24,.2)" />
            </g></g>
            <g transform="rotate(-90) translate(49,-30)" className="pencil__point"><polygon points="15 0,30 30,0 30" fill="#d6b27a" /><polygon points="15 0,6 30,0 30" fill="#a77b4d" /><polygon points="15 0,20 10,10 10" fill="#202823" /></g>
          </g>
        </svg>
