...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top"><div className="hero-inner"><div className="eyebrow"><strong>ANJANI BEESU</strong></div><h1>Building things<br />worth clicking</h1><p className="hero-copy">CSE student, builder, and curious human.</p><div className="actions"><a className="button" href="#work">Explore my work ↗</a><a className="button primary" href="#contact">Connect with me ↗</a></div></div><div className="corner-note">SCROLL TO EXPLORE ↓</div></section>
