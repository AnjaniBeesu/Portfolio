...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top"><div className="hero-inner"><div className="eyebrow">Anjani Beesu</div><h1>Building things<br />worth clicking on.</h1><p className="hero-copy">CSE student, builder, and curious human.</p><div className="actions"><a className="button" href="#work">Explore my work ↗</a><a className="button primary" href="#contact">Connect with me ↗</a></div></div><div className="corner-note">SCROLL TO EXPLORE ↓</div></section>

    <section className="section about-section" id="about"><div className="section-label">01 / ABOUT ME</div><div className="about-grid"><div><h2>Hi, I&apos;m Anjani.</h2><p>I&apos;m currently pursuing my <strong>B.Tech in Computer Science &amp; Engineering</strong>.</p><p><strong>Grade: 9.15</strong></p><p>I build things that are intentional, useful, and <strong>eye-candy shit</strong> — because technically functional doesn&apos;t have to mean boring.</p></div><div className="leadership"><div className="mini-label">LEADERSHIP</div><h3>Class Representative &amp; Event Organizer</h3><p className="date">AUG 2025 — PRESENT</p><p>I&apos;m a CR and event organizer — coordinating people, getting things moving, and turning ideas into actual college events. I&apos;ve organized several departmental events and a college-level event.</p></div></div></section>
